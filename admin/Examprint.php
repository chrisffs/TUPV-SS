...
<main class="container mx-auto flex print-hide flex-col items-center gap-10">
    <section id="" class="print-hide w-[21cm] p-[1cm] min-h-[29.7cm] mt-10 border border-[#D3D3D3] shadow-lg">
            ...
            <div class="">
                ...
                <div class="flex justify-center">
                    <div class="grid grid-cols-1 mt-2">
                        ...
                        foreach ($questions as $row):
                        ?>
                        <div class="grid grid-cols-3 text-xs gap-2 content-center circles">
                            <div class="col-span-1 pt-1 flex items-center justify-end">
                                <h1><?php echo $i ?>.)</h1>
                            </div>
                            <div class="col-span-2 flex pt-1 px-2 border-black border-x-2 w-full justify-center gap-1">
                                <div class="">
    ...
    <section id="" class="print-hide print-hide w-[21cm] p-[1cm] min-h-[29.7cm] mb-10 border border-[#D3D3D3] shadow-lg">
        <header class="text-xs mb-4">
            <div class="grid grid-cols-9">
                <div class="col-span-1">
                    <img class="object-cover " src="../src/img/tupvlogo.png" alt="">

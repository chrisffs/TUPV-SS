        ...
        <div class="p-0 md:pr-4 lg:pr-6 md:w-2/3  h-full">
            <form id="addUserForm" method="post" action="../php/user_insert.php" enctype="multipart/form-data" class="border rounded-lg p-4 lg:p-6">
                ...
                <div class="flex items-center justify-end p-2 border-gray-200 rounded-b dark:border-gray-600">
                    <button form="uploadFileForm" type="submit" value="Submit" name="insertfile" class="text-white bg-main hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-blue-800">Upload File</button>
                </div>
            </form>
        </div>

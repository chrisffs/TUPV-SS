    ...
    <div class="flex flex-col md:flex-row md:divide-x">
        <div class="p-0 md:pr-4 lg:pr-6 md:w-2/3 h-full">
            <form id="checkExam" method="post" action="../php/check_exam.php" enctype="multipart/form-data" class="border rounded-lg p-4 lg:p-6">
                <div class=" mb-6  text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                    <p class="text-2xl font-semibold text-left">
                        Upload File to Check Your Exam
                    </p>
                    
                    <div class="mt-2">
                        <h2 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">When using computer devices:</h2>
                        <ul class="mb-2 max-w-md space-y-1 text-gray-500 list-none list-inside dark:text-gray-400 ">
                            <li>
                                Make sure the file being uploaded is clear.
                            </li>
                        </ul>
                        <h2 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">On Small Devices:</h2>
                        <ul class="mb-2 max-w-md space-y-1 text-gray-500 list-none list-inside dark:text-gray-400 ">
                            <li>
                                On capturing the actual answersheet, make sure to have a clear photo with brilliant lightings and shadows.
                            </li>
                        </ul>
                        <h2 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">General Instructions:</h2>
                        <ul class="mb-2 max-w-md space-y-1 text-gray-500 list-none list-inside dark:text-gray-400 ">
                            <li>
                                Input the Code before uploading (on the right side) Key Codes and upload.
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <aside class="py-6 pl-4 lg:pl-6 md:w-1/3">
            <div class="h-full">
                <div class="mb-4">
                    <h1 class="text-xl font-semibold">Key Codes</h1>

...
<header class="antialiased">
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 container mx-auto dark:bg-gray-800">
        ...
        <div id="extralarge-modal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative w-full max-w-7xl max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <!-- Modal body -->
                    <div class="p-6 grid grid-cols-3 gap-x-4">
                        <div class="">Syllabus</div>
                        <div class="">Exam Maker and Checker</div>
                        <div class="">Submit Module and Question </div>
                    </div>
                    <!-- Modal footer -->

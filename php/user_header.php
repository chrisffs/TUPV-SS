        ...
        <div class="flex flex-wrap justify-between items-center">
            ...
            <div class="flex items-center md:order-2">
                ...
                <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600" id="apps-dropdown">
                    ...
                    <div class="grid grid-cols-3 gap-4 p-4">
                        ...
                        <a href="../user/examchecker.php" class="block p-4 text-center rounded-lg <?php if($page=='examchecker'){echo 'bg-gray-100 text-gray-500';} else {echo 'hover:bg-gray-100 text-gray-400';}?> hover:bg-gray-100 group">
                            <svg class="mx-auto mb-2 w-5 h-5 text-gray-400 group-hover:text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 20">
                        ...
                        <a href="../user/uploadsyllabus.php" class="block p-4 text-center rounded-lg <?php if($page=='uploadsyllabus'){echo 'bg-gray-100 text-gray-500';} else {echo 'hover:bg-gray-100 text-gray-400';}?> hover:bg-gray-100 group">
                            <svg class="mx-auto mb-2 w-5 h-5 text-gray-400 group-hover:text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                ...
                <button type="button" class="flex mx-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="dropdown">
                    ...
                    <img class="w-8 w-10 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="user photo">
                </button>
                <!-- Dropdown menu -->
        ...
        <div id="extralarge-modal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative w-full max-w-7xl max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <!-- Modal body -->
                    <div class="p-6 grid grid-cols-3 gap-x-4 custom-gradient">
                        <div class="bg-light border rounded-lg p-10 ">
                            <div class="w-60 mx-auto">
                                <img class="w-60 " src="../src/img/syllabus_modal-pic.png" alt="" srcset="">
                            </div>
                            <div class="text-center mt-4">
                                <h1 class="font-bold text-xl">Syllabus</h1>
                                <h3 class="text-sm font-semibold mb-4">Search, and Download Learning Materials and Modules</h3>
                                <h5 class="text-sm">Allows educators to effortlessly share, explore, and access a vast array of learning materials and modules.</h5>
                            </div>
                        </div>
                        <div class="bg-light border rounded-lg p-10 ">
                            <div class="w-60 mx-auto">
                            ...
                            <div class="text-center mt-4">
                                <h1 class="font-bold text-xl">Exam Maker and Checker</h1>
                                <h3 class="text-sm font-semibold mb-4">Create Exam Test Paper and Automatic Checking</h3>
                                <h5 class="text-sm">Empowers educators to effortlessly create and grade exams with ease.</h5>
                            </div>
                        </div>
                        <div class="bg-light border rounded-lg p-10 ">
                            <div class="w-60 mx-auto">
                            ...
                            <div class="text-center mt-4">
                                <h1 class="font-bold text-xl">Submit Module and Question</h1>
                                <h3 class="text-sm font-semibold mb-4">Upload learning materials and test questions for exam</h3>
                                <h5 class="text-sm">Accepts user’s uploaded questions, modules and other learning materials.</h5>
                            </div>
                        </div>
                    </div>
                    <!-- Modal footer -->
    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-16 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="../user/" class="flex items-center justify-center p-2 <?php if($page=='syllabus'){echo 'text-main bg-red-100';} else {echo 'hover:bg-gray-100 text-gray-500';}?> rounded-lg dark:text-white group">
                ...
                <li>
                    <a href="../user/exammaker.php" class="flex items-center justify-center p-2 <?php if($page=='exammaker'){echo 'text-main bg-red-100';} else {echo 'hover:bg-gray-100 text-gray-500';}?> rounded-lg dark:text-white group">
                ...
                <li>
                    <a href="../user/examchecker.php" class="flex items-center justify-center p-2 <?php if($page=='examchecker'){echo 'text-main bg-red-100';} else {echo 'hover:bg-gray-100 text-gray-500';}?> rounded-lg dark:text-white group">
                ...
                <li>
                    <a href="../user/uploadsyllabus.php" class="flex items-center justify-center p-2 <?php if($page=='uploadsyllabus'){echo 'text-main bg-red-100';} else {echo 'hover:bg-gray-100 text-gray-500';}?> rounded-lg dark:text-white group">
                        <svg class="flex-shrink-0 w-5 h-5 transition duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            <path d="m14.707 4.793-4-4a1 1 0 0 0-1.416 0l-4 4a1 1 0 1 0 1.416 1.414L9 3.914V12.5a1 1 0 0 0 2 0V3.914l2.293 2.293a1 1 0 0 0 1.414-1.414Z"/>
                            <path d="M18 12h-5v.5a3 3 0 0 1-6 0V12H2a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2Zm-3 5a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"/>
                        </svg>
                ...
                <li>
                    <a href="../user/questionbank.php" class="flex items-center justify-center p-2 <?php if($page=='questionbank'){echo 'text-main bg-red-100';} else {echo 'hover:bg-gray-100 text-gray-500';}?> rounded-lg dark:text-white group">
                        <svg class="flex-shrink-0 w-5 h-5 transition duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm0 16a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3Zm1-5.034V12a1 1 0 0 1-2 0v-1.418a1 1 0 0 1 1.038-.999 1.436 1.436 0 0 0 1.488-1.441 1.501 1.501 0 1 0-3-.116.986.986 0 0 1-1.037.961 1 1 0 0 1-.96-1.037A3.5 3.5 0 1 1 11 11.466Z"/>
                        </svg>
                    </a>

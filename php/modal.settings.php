    ...
    <div class="relative w-full max-w-md max-h-full">
        ...
        <form method="post" action="../php/insert.php">
            ...
            <div class="flex items-center py-6 mx-5 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                <input  data-modal-hide="addDepartment-modal" type="submit" name="insertdpt" value="Add Department" class="text-white bg-main hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-blue-700 dark:focus:ring-red-800">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="modal-body p-6 space-y-6">
                ...
                <label for="courseName" class="block my-2 text-sm font-medium text-gray-900 dark:text-white">Course Name</label>
                    ...
                    <option value="acronym"> <?php echo $row['acronym']; ?></option>
                    <?php endforeach; ?>
    ...
    <div class="relative w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between py-5 mx-5 border-b rounded-t dark:border-gray-600">
                ...
                <!-- Modal body -->
            <div class="modal-body p-6 space-y-6">
                <form id="editDeptForm" method="post" action="../php/editdepartment.setting.php">
                <!-- Input fields will be added dynamically here -->
                    <input type="hidden" name="editid" id="editid" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                    ...
                    <label for="editacronym" class="block my-2 text-sm font-medium text-gray-900 dark:text-white">Department Acronym</label>
                    <input type="text" name="editacronym" id="editacronym" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                </form> 
            </div>
                <!-- Modal footer -->
            <div class="flex items-center py-6 mx-5 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                <button form="editDeptForm" data-modal-hide="editDepartment-modal" type="submit" value="Add Department" class="text-white bg-main hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-blue-700 dark:focus:ring-red-800" name="updateDept">Update</button>

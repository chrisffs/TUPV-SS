                ...
                <form id="uploadFileForm" method="post" action="../php/fileupload.admin.syllabus.php" enctype="multipart/form-data">
                    <div class="grid gap-2 sm:grid-cols-4 content-end">
                        ...
                        <div class="sm:col-span-4">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="upload_file">Upload File</label>
                            <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="upload_file" type="file" name="file" required>
                        </div>
                    </div>
                </form>
            </div>
